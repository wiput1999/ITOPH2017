    ...
    <div class="paper">
        <div class="container">
            <section class="regis-header">
                <h1 class="text-center">ลงทะเบียนการแข่งขันความปลอดภัยของระบบคอมพิวเตอร์</h1>
            ...
            <section class="regis-form">
                <form action="{{url('/competition/network/register')}}" method="post">
                    {!! csrf_field() !!}
                    {{--ทีม--}}
                    <h3>ชื่อทีม</h3>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="e.g. 080808xxxx" name="phone[]" value="{{ old('phone')[0] }}" required>
                            </div>
                        </div>
                    </div>
                    <h4>สมาชิก 2</h4>
