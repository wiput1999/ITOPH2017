...
@section('content')
    ...
    <form action="{{URL::route('backend.competition.network.update', $data->id)}}" method="post">
        {!! csrf_field() !!}
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="e.g. 080808xxxx" name="phone[]" value="{{ $data['phone'][0] }}" required>
                        </div>
                    </div>
                </div>
                <h4>สมาชิก 2</h4>
