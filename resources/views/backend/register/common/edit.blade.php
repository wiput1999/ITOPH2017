...
@section('content')
    ...
    <form action="{{URL::route('backend.register.common.update', $data->id)}}" method="post">
        {!! csrf_field() !!}
        {{ method_field('PUT') }}
        {{--ข้อมูลส่วนตัว--}}
        <h3>ข้อมูลส่วนตัว</h3>
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        <div class="form-group">
                            <label>ชื่อ</label>
                            <input type="text" class="form-control" placeholder="ไอที" name="name" value="{{ $data['name'] }}" required>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    <label>นามสกุล</label>
                    <input type="text" class="form-control" placeholder="ลาดกระบัง" name="surname" value="{{ $data['surname'] }}" required>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 col-xs-6">
                <div class="form-group">
                    <label>อาชีพ</label>
                    <input type="text" class="form-control" placeholder="e.g. เจ้าของStartupชั้นนำของเมืองไทย" name="career" required value="{{ $data['career'] }}">
                </div>
            </div>
            <div class="col-md-6 col-xs-6">
                <div class="form-group">
