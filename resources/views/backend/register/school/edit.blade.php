...
@section('content')
    ...
    <form action="{{URL::route('backend.register.school.update', $data->id)}}" method="post">
        {!! csrf_field() !!}
        {!! method_field('PUT') !!}
        {{--ข้อมูลส่วนตัว--}}
        <h3>ข้อมูลส่วนตัว</h3>
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="ชื่อโรงเรียน" name="school" required value="{{ $data['school'] }}">
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="e.g. 1000000" name="follower" required value="{{ $data['follower'] }}">
                </div>
            </div>
        </div>
        {{--end ข้อมูลส่วนตัว--}}
